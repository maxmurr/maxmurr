          ...
          {SITE_CONFIG.socialLinks.map((link) => {
            ...
            return (
              <a
                ...
                className="text-muted-foreground transition-[color,transform] duration-150 ease-out will-change-transform pointer-fine:hover:scale-105 hover:text-foreground active:scale-[0.97]"
              >
